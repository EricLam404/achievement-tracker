        ...
        return (
            <>
                ...
                <form
                    ...
                    onSubmit={handleSubmit}
                >
                    <label className="labal" htmlFor="name">
                        Student Name:
                    </label>
                    <input
                        ...
                        required
                    />
                    <label className="labal" htmlFor="email">
                        Email:
                    </label>
                    <input
                        className="input input-bordered w-full max-w-xs"
                        ...
                        required
                    />
                    <label className="labal" htmlFor="dob">
                        Date of birth:
                    </label>
                    <input
                        className="input input-bordered w-full max-w-xs"
                        ...
                        required
                    />
                    <label className="labal" htmlFor="age">
                        Age:
                    </label>
                    <input
                        className="input input-bordered w-full max-w-xs"
                        ...
                        required
                    />
                    <label className="labal" htmlFor="phone">
                        Phone Number:
                    </label>
                    <input
                        className="input input-bordered w-full max-w-xs"
                        ...
                        required
                    />
                    <label className="labal" htmlFor="address">
                        Address:
                    </label>
                    <input
                        className="input input-bordered w-full max-w-xs"
                        ...
                        required
                    />
                    <label className="labal" htmlFor="started">
                        Started:
                    </label>
                    <input
                        className="input input-bordered w-full max-w-xs"
                        ...
                        required
                    />
                    <label className="labal" htmlFor="day">
                        Day:
                    </label>
                    <input
                        className="input input-bordered w-full max-w-xs"
                        ...
                        required
                    />
                    <label className="labal" htmlFor="time">
                        Time:
                    </label>
                    <input
                        className="input input-bordered w-full max-w-xs"
