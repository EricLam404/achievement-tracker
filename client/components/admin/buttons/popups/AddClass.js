        ...
        return (
            <>
                ...
                <form
                    ...
                    onSubmit={handleSubmit}
                >
                    <label className="labal" htmlFor="classDate">
                        Class Date:
                    </label>
                    <input
                        ...
                        required
                    />
                    <label className="labal" htmlFor="classAchievement">
                        Class Achievement:
                    </label>
                    <input
                        className="input input-bordered w-full max-w-xs"
                        ...
                        onChange={(event) =>
                            setClassAchievement(event.target.value)
                        }
                        required
                    />
                    <label className="labal" htmlFor="classLesson">
                        Class Lesson:
                    </label>
                    <input
                        className="input input-bordered w-full max-w-xs"
                        ...
                        required
                    />
                    <label className="labal" htmlFor="classLevel">
                        Class Level:
                    </label>
                    <input
                        className="input input-bordered w-full max-w-xs"
