        ...
        <>
            ...
            {user && (
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        <label htmlFor="parentName" className="block font-medium mb-1">Parent's Name</label>
                        <input
                            type="text"
                            id="parentName"
                            value={parentName}
                    ...
                    <div className="mb-4">
                        <label htmlFor="parentDOB" className="block font-medium mb-1">Parent's Date of Birth</label>
                        <input
                            type="date"
                            id="parentDOB"
                            value={parentDOB}
                    ...
                    <div className="mb-4">
                        <label htmlFor="childName" className="block font-medium mb-1">Student Id</label>
                        <input
                            type="text"
                            id="childName"
                            value={studentId}
